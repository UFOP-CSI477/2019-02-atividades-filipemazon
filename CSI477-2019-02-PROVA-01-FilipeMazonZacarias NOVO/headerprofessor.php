  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="pesquisaAluno.php">Relatório de Estudantes</a></li>
            <li><a href="pesquisaProfessorprof.php">Relatório de Professores</a></li>
          </ul>
        </li>
      ...
      <a class="dropdown-toggle" data-toggle="dropdown" href="#">PROJETOS
          <span class="caret"></span></a>
          <ul class="dropdown-menu">
            <li><a href="cadastraProjeto.php">Novo Projeto</a></li>
            <li><a href="pesquisaProjetosp.php">Listar Projetos</a></li>
